...
export class Provider<TModel extends IModel = any> implements IProvider<TModel> {
  ...
  instanceofNestedFactoryModel(data: any) {
    return (
      ...
      Object.keys(this.factoryModel.nested).filter(key => data instanceof this.factoryModel.nested[key]).length > 0
    );
  }
  ...
  calcPaginationMetaByOptions(options: IProviderOptions<TModel>): IPaginationMeta {
    ...
    paginationMeta.totalResults =
      options === undefined || options.paginationMeta === undefined || options.paginationMeta.totalResults === undefined
        ? paginationMeta.totalResults
        : options.paginationMeta.totalResults;
    paginationMeta.perPage =
      options === undefined || options.paginationMeta === undefined || options.paginationMeta.perPage === undefined
        ? paginationMeta.perPage
        : options.paginationMeta.perPage;
    paginationMeta.curPage =
      options === undefined || options.paginationMeta === undefined || options.paginationMeta.curPage === undefined
        ? paginationMeta.curPage
        : options.paginationMeta.curPage;
